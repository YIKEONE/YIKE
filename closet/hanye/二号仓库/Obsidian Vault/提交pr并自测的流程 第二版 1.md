1.代码在本地整编过后，再提pr！！！！
 提完PR，填写内部合入检视表，门禁过了之后就自测，自验证L0 top0，测试没问题给测试发门禁压缩包然后 填写三个表：再加一个[蓝区so包及RK蓝区测试用例-L0&Top01](https://neusoft.feishu.cn/sheets/UCr0se7pAhQTYitHaJbcAwlsnVe?sheet=G8Chwt)这个表可以在未测试时候填写，但是状态为未合入
 ![[img_v3_02cr_92204f5c-a65e-4239-9146-9a842484ab5g.jpg]]
 ![[Pasted image 20240716133718.png]]

@所有人 so包表蓝区黄区同步请参照： 1.业务代码PR完成提出后，先进行自测，自测通过门禁通过后填写【蓝区so包表】

[蓝区so包及RK蓝区测试用例-L0&Top01](https://neusoft.feishu.cn/sheets/UCr0se7pAhQTYitHaJbcAwlsnVe?sheet=G8Chwt)

2.蓝区so包验证通过后，填写

[合作共建-东软团队-交付进展](https://neusoft.feishu.cn/sheets/H9yLsWuDMhcVQ9tk85UcocrTn2f?sheet=mePodv)

【合入详细】表 【SO包合集】表（如有依赖PR请务必填写）和 【PR推进表】 [3.PR](http://3.pr/)提交后，若12小时未能合入，请主动重新触发门禁。每天及时查看PR是否有评论需要修改。 4.TDD代码提交，请check 单个文件小于2000行，单笔提交PR代码量小于2000行，TDD结果贴PR上，填写【PR推进表】。 5.通用规范修改，请每个PR提一个自提单，填写【PR推进表】【DTS表】。只涉及格式修改的内容可以不填【蓝黄区so包合集表】，例如：加空格，超50行换行等。如果修改涉及到可能存在的逻辑变更，需要参照 规则第一条执行，例如“==”变更为“===”等。
...
1.接口PR门禁报这个错误的意思是需要走电子流：
![[img_v3_02cr_23eb766d-97bc-4c2f-a0a4-bdef7e51a52g.jpg]]
